...
public class loanemi {
	...
	private void initialize() {
		...
		JButton btnNewButton_3 = new JButton(" Exit Calculator");
		...
		gl_panel_1_1.setHorizontalGroup(
			gl_panel_1_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1_1.createSequentialGroup()
					...
					.addGap(75)
					.addComponent(btnNewButton_2, GroupLayout.PREFERRED_SIZE, 252, GroupLayout.PREFERRED_SIZE)
					.addGap(80)
					.addComponent(btnNewButton_3, GroupLayout.PREFERRED_SIZE, 228, GroupLayout.PREFERRED_SIZE)
		...
		textField_4.setFont(new Font("Tahoma", Font.BOLD, 19));
